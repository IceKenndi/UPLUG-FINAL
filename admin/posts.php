            ...
            <div class="post-list" id="faculty-posts-list">
              ...
              <?php else: ?>
                <?php foreach ($facultyPosts as $post): ?>
                  <div class="post-card"
                   data-id="<?= htmlspecialchars($post['post_id']) ?>"
                   data-post-type="<?= htmlspecialchars($post['post_type']) ?>"
                   data-author-id="<?= htmlspecialchars($post['author_id']) ?>">
                    ...
                    <div class="post-cell type"><?= ucfirst(htmlspecialchars($post['post_type'])) ?></div>
  ...
  document.getElementById("deleteModal").style.display = "none";
    ...
    document.addEventListener("click", e => {
      if (e.target.classList.contains("view-btn")) {
        ...
        const authorId = card.dataset.authorId; // ✅ get author id here
        ...
        // ✅ Combine name + author ID only inside modal
        const authorName = card.querySelector(".name").textContent.trim();
        document.getElementById("viewAuthor").textContent = `${authorName} - ${authorId}`;
